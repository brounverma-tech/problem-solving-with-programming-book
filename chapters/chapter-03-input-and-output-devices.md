...
# ⌨️ Chapter 3: Input and Output Devices
...
- Input aur output devices ko define kar सकेंगे.
- Different input devices aur unke uses explain kar सकेंगे.
- Keyboard aur pointing devices ke types samajh सकेंगे.
- Scanning and recognition devices mein difference bata सकेंगे.
- Different output devices identify kar सकेंगे.
- Monitor, printer, plotter, projector aur audio devices explain kar सकेंगे.
- Softcopy aur hardcopy output mein difference kar सकेंगे.
- Suitable task ke liye correct input/output device select kar सकेंगे.
...
|---|---|---|
| Direction | User se computer | Computer se user |
| Function | Data/instructions enter karta hai | Result present karta hai |
...
|---|---|---|
| Input | इनपुट | Computer ko diya gaya data |
| Output | आउटपुट | Computer se mila result |
| Peripheral | पेरिफेरल | Computer se connected supporting device |
| Interface | इंटरफेस | Components ke beech connection method |
| Cursor | कर्सर | Screen par current position indicator |
| Resolution | रेज़ोल्यूशन | Image/display ki detail level |
| Recognition | रिकग्निशन | Pattern ya character ko identify karna |
...
- Biometric devices
- Touch and sensor-based devices
...
- Fast text entry
- Easy to use
- Accurate command entry
- Widely available

**Limitations:**

- Large data typing tiring ho sakta hai.
- Incorrect typing se errors hote hain.
- Images aur natural handwriting directly enter nahi karta.
...
|---|---|---|
| Mouse | General pointer control | Desktop |
| Touchpad | Pointer control | Laptop |
| Trackball | Limited-space control | Specialized systems |
| Joystick | Directional control | Games/simulators |
| Stylus | Drawing/writing | Tablet/design system |
...
> **DPI** ka full form **Dots Per Inch** hai. Higher DPI generally more detail capture karta hai.
...
|---|---|---|
| OCR | Printed characters | Document digitization |
| OMR | Filled marks | Exams and surveys |
| MICR | Magnetic-ink characters | Bank cheques |
| Barcode Reader | Linear barcode | Retail products |
| QR Reader | 2D code | Payments and links |
...
- Multipart forms print kar sakta hai.
- Running cost low ho sakti hai.
- Rugged environment mein useful.
...
|---|---|---|
| Printing Method | Physical striking | No physical striking |
| Noise | Noisy | Quiet |
...
| Best For | Color/photo and low volume | Text and high volume |
| Speed | Generally slower | Generally faster |
| Initial Cost | Often lower | Often higher |
| Text Quality | Good | Very sharp |
...
| Printer | Plotter |
|---|---|
| General documents and images | Large precise drawings |
| Common office/home use | Engineering/design use |
| Smaller standard paper sizes | Large media support |
| Text and raster output | Precise lines/vector drawings |
...
- Electricity ke bina view ho sakti hai
- Physical storage space chahiye
...
| Device Needed to View | Yes | Usually no |
| Editing | Easy | Difficult |
| Sharing | Fast digital sharing | Physical transfer |
| Cost | Low copying cost | Paper/ink cost |
| Examples | Screen PDF, video | Printed page, poster |
...
|---|---|
| Long text typing | Keyboard |
| Pointer control | Mouse/touchpad |
| Printed page digitize karna | Scanner |
| Editable printed text banana | Scanner + OCR |
| MCQ sheet read karna | OMR |
| Bank cheque read karna | MICR |
| Product code read karna | Barcode reader |
| Video call | Webcam + microphone |
| Visual display | Monitor/projector |
| Paper document | Printer |
| Engineering drawing | Plotter |
| Sound output | Speaker/headphones |
...
- OCR printed text ko editable text mein convert karta hai.
- OMR marked answers aur MICR bank-cheque characters read karta hai.
- Touchscreen input aur output dono device hai.
- Monitor visual softcopy output provide karta hai.
- Resolution screen ya print detail ko represent karti hai.
- Impact printers paper ko physically strike karte hain.
- Inkjet, laser aur thermal non-impact printers hain.
- Printer documents aur plotter large technical drawings banata hai.
- Softcopy digital aur hardcopy physical output hoti hai.
...
### 2. MCQ answer sheets read karne ke liye kya use hota hai?
...
### 3. Bank cheques par special characters kaun read karta hai?
...
### 4. Kaunsa device input aur output dono hai?
...
### 5. Printed text ko editable digital text mein kaun convert karta hai?
...
### 7. Large engineering drawings ke liye suitable device kaunsa hai?
...
### 8. Screen par displayed PDF kya hai?
...
### 9. Laser printer kis material ka use karta hai?
...
### 10. Print resolution generally kis unit mein hoti hai?
...
3. Keyboard ke different key groups likhiye.
4. Mouse ke common operations kya hain?
5. Scanner kya karta hai?
6. OCR aur OMR mein difference likhiye.
7. MICR kahan use hota hai?
8. Biometric input device kya hai?
9. Monitor resolution kya hoti hai?
10. Impact aur non-impact printers mein difference likhiye.
11. Inkjet aur laser printer compare kijiye.
12. Plotter ka use kya hai?
13. Softcopy aur hardcopy ko define kijiye.
14. Touchscreen input aur output dono kaise hai?
...
3. Scanner, OCR, OMR, MICR aur barcode reader explain kijiye.
4. Different types of output devices ko examples ke saath describe kijiye.
5. Monitor ke types aur quality factors explain kijiye.
6. Impact aur non-impact printers ko types ke saath explain kijiye.
7. Inkjet, laser, thermal aur dot-matrix printers compare kijiye.
8. Softcopy aur hardcopy output ko examples ke saath differentiate kijiye.
9. Audio, video, touch aur biometric devices ke uses explain kijiye.
10. Different tasks ke liye suitable input/output devices select karke reasons dijiye.
...
3. Kisi document ko scan karke OCR se editable text banaiye.
4. Monitor ki current resolution aur refresh rate check kijiye.
5. Nearby shop ya office mein used printer ka type identify kijiye.
6. Input aur output devices ka labeled chart banaiye.
7. Softcopy aur hardcopy ke five daily-life examples likhiye.
...
3. OCR ka full form kya hai?
4. OMR ka common application kya hai?
5. MICR bank mein kyun use hota hai?
6. Touchscreen kis category mein aata hai?
7. Monitor softcopy kaise provide karta hai?
8. Dot-matrix printer noisy kyun hota hai?
9. Plotter aur printer mein main difference kya hai?
10. Hardcopy ko electricity ke bina kyun padha ja sakta hai?
...
3. OCR ka full form Optical Character Recognition hai.
4. OMR exams ki marked answer sheets read karta hai.
5. MICR magnetic ink ke secure special characters quickly read karta hai.
6. Touchscreen input aur output dono category mein aata hai.
7. Monitor result ko electronic visual form mein display karta hai.
8. Dot-matrix pins ribbon aur paper ko physically strike karti hain.
9. Printer general documents aur plotter large precise drawings banata hai.
10. Hardcopy physical paper ya material par permanently visible hoti hai.
